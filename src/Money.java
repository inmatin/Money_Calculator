 ...
 * Description: This class stores the amount of toonie, loonie, quarter, dime
 * and nickel
 */
...
public class Money {
	...
	// this method multiplies each type of coin by the monetary value of the
	// coin to get the total amount of money
